...
export default function Cardapio() {
    ...
    const [confirmandoExcluir, setConfirmandoExcluir] = useState(null); // id do produto
    const [modalPedido, setModalPedido] = useState(null); // produto selecionado
    ...
    const buscarMesas = async () => {
        try {
            ...
            const data = await res.json();
            setMesas(data.filter(m => m.status === 'disponivel'));
        } catch {}
    };
            ...
            {modalPedido && (
                <div className={styles.modalOverlay}>
                    <div className={styles.modal}>
                        ...
                        <div className={styles.modalBotoes}>
                            <button className={styles.modalBtnCancelar} onClick={() => { setModalPedido(null); setQuantidade(1); setMesaSelecionada(''); }}>
                                Cancelar
                            </button>
