...
function Dashboard() {
    ...
    return (
        <div className={styles.dashboardContainer}>
            ...
            <h1>Olá, {user.nome}
                <button className={styles.btnEditarPerfil} onClick={() => navigate('/editarperfil')}> Editar perfil
                </button>
            </h1>
            ...
            <aside className={styles.sidebar}>
                <nav>
                    <ul>
                        ...
                        {user.id_tipo === 1 && (
                            <li><a href="/adicionarusuarios">Adicionar Usuários</a></li>
                        )}
                        {user.id_tipo === 1 && (
                    ...
                    {!loading && !erro && usuarios.map(u => (
                        <div key={u.id} className={styles.card}>
                            <div className={styles.cardHeader}>
                                <h3>{u.nome}</h3>
                                <span
                                    className={`${styles.badge} ${u.tipo === 'admin' ? styles.badgeAdmin : styles.badgeGarcom}`}>
                            ...
                            <div className={styles.cardMeta}>
                                <span
                                    className={`${styles.badge} ${u.bloqueado === 'Sim' ? styles.badgeBloqueado : styles.badgeAtivo}`}>
